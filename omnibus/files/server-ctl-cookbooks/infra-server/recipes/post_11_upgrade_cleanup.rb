...
infra_server_package_cleaner 'opscode-authz' do
...
infra_server_package_cleaner 'nagios' do
...
infra_server_package_cleaner 'nrpe' do
  directories ['/var/opt/opscode/nrpe',
               '/var/log/opscode/nrpe']
end

infra_server_package_cleaner 'fastcgi' do
