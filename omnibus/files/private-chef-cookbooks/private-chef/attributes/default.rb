...
default['private_chef']['opscode-erchef']['solr_ibrowse_options'] = '[{connect_timeout, 10000}, {prefer_ipv6, false}]'
...
default['private_chef']['opscode-erchef']['s3_ssl_options'] = '[{connect_timeout, 10000}]'
default['private_chef']['opscode-erchef']['s3_ibrowse_options'] = '[{prefer_ipv6, false}]'
