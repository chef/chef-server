...
private_chef_pg_database 'bifrost' do
  ...
  notifies :deploy, "private_chef_pg_sqitch[/opt/opscode/embedded/service/oc_erchef/bdb]", :immediately
end
...
private_chef_pg_sqitch "/opt/opscode/embedded/service/oc_erchef/bdb" do
