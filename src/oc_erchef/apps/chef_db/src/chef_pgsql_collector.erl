...
-define(METRICS, [
                  {<<"seq_scan">>, {pg_stat_seq_scan, counter, "Number of sequential scans initiated", fun erlang:binary_to_integer/1}},
                  ...
                  {<<"n_tup_upd">>, {pg_stat_n_tup_upd, counter, "Number of rows updated", fun erlang:binary_to_integer/1}},
                  {<<"n_tup_del">>, {pg_stat_n_tup_del, counter, "Number of rows deleted", fun erlang:binary_to_integer/1}},
                  {<<"n_live_tup">>, {pg_stat_n_live_tup, gauge, "Estimated number of live rows", fun erlang:binary_to_integer/1}},
                  {<<"n_dead_tup">>, {pg_stat_n_dead_tup, gauge, "Estimated number of dead rows", fun erlang:binary_to_integer/1}},
                  {<<"heap_blks_read">>, {pg_stat_heap_blocks_read, counter, "Number of disk blocks read", fun erlang:binary_to_integer/1}},
                  {<<"heap_blks_hit">>, {pg_stat_heap_blocks_hit, counter, "Number of buffer hits", fun erlang:binary_to_integer/1}},
