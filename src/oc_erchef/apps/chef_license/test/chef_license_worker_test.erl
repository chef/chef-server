...
license_test()->
    ...
    refresh_license(),
    timer:sleep(100),
    {Result, _, _} = chef_license_worker:get_license(),
    ...
    refresh_license(),
    timer:sleep(100),
    {Result1, _, _} = chef_license_worker:get_license(),
    ...
    refresh_license(),
    timer:sleep(100),
    {Result2, _, _} = chef_license_worker:get_license(),
    ...
    refresh_license(),
    timer:sleep(100),
    {Result3, _, _} = chef_license_worker:get_license(),
    ...
    refresh_license(),
    timer:sleep(100),
    {Result4, _, _ } = chef_license_worker:get_license(),
