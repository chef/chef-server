...
transform_query_safe(Data) when is_binary(Data) ->
    list_to_binary(cs_escape:escape_safe(binary_to_list(Data))).

transform_query_term(Data) when is_binary(Data) ->
    list_to_binary(cs_escape:escape_term_safe(binary_to_list(Data))).

transform_query_phrase(Data) ->
    list_to_binary(cs_escape:escape_phrase_safe(binary_to_list(Data))).
