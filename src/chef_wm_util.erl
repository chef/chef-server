...
fetch_org_guid_and_authz(#base_state{organization_name = undefined}) ->
    {undefined, undefined};
fetch_org_guid_and_authz(#base_state{organization_guid = Id, organization_authz_id=AuthzId}) when is_binary(Id) ->
    {Id, AuthzId};
