...
EOF
  ...
  env_helper = "veil-env-helper --use-file -f /etc/#{ChefUtils::Dist::Org::LEGACY_CONF_DIR}/private-chef-secrets.json -s chef-server.webui_key -s oc_id.sql_password -s oc_id.secret_key_base"
