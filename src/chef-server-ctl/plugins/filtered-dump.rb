...
add_command_under_category "filtered-dump", "Debug Tools", "Generate a filtered dump of indexable #{ChefUtils::Dist::Infra::SHORT.capitalize} Objects for all organizations. Top-level data is captured; only object name is captured from object json" do
  require "json"
  require "zlib"
  require "stringio"
