...
def get_server_admins_authz_id(db)
  ...
  if server_admins_erchef_group.ntuples == 0
    msg = "The server-admins global group was not found. Please finish upgrading your #{ChefUtils::Dist::Server::PRODUCT} by following the documentation before using Server Admins related commands."
    STDERR.puts msg
    raise SystemExit.new(1, msg)
  end
