...
resource_exists(Rq0, Ctx) ->
    ...
    {bksw_sql_io:bucket_exists(Bucket), Rq0, Ctx}.

delete_resource(Rq0, Ctx) ->
    Bucket = bksw_util:get_bucket(Rq0),
    {bksw_sql_io:bucket_delete(Bucket), Rq0, Ctx}.

create_resource(Rq0, Ctx) ->
    Bucket = bksw_util:get_bucket(Rq0),
    {bksw_sql_io:bucket_create(Bucket), Rq0, Ctx}.

to_xml(Rq0, Ctx) ->
    Bucket = bksw_util:get_bucket(Rq0),
    Objects = bksw_sql_io:entry_list(Bucket),
